      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <KlineChartCard
            ...
            fetchedAt={klineFetchedAt}
            etfCode={etfCode}
            etfQuote={etfCode ? valuations[etfCode]?.quote || null : null}
            onRefreshQuote={handleRefreshQuotes}
            quoteRefreshing={refreshing.quotes}
        ...
        <div className="space-y-4">
                      ...
                      {portfolio.holdings.map((h, i) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1.5 shrink-0">
                            <span
                              className={`font-mono font-medium ${h.ratio >= 5 ? "text-red-500" : ""}`}
                            >
                              {h.ratio.toFixed(1)}%
                            </span>
          ...
          {/* 分析 Prompt / 直接调用 AI（Tab 切换：生成 Prompt ↔ 直接调用 AI） */}
            ...
            <CardContent className="space-y-3">
              ...
              <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "prompt" | "ai")}>
                ...
                <TabsContent value="ai" className="space-y-2">
                  ...
                  {aiError && (
                    <p className="text-[11px] text-destructive leading-relaxed">⚠ {aiError}</p>
                  )}
                  {aiResponse ? (
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
