              ...
              <SortBtn
                ...
                desc={
                  <>
                    ...
                    <div>
                      排序：百分位<b className="font-semibold">从小到大</b>，前 12% 排最前、后 50%
                      沉底。
                    </div>
                    <div className="opacity-80">需开启东财增强；无数据沉底。</div>
                  </>
                  ...
                  <table className="w-full text-xs">
                    <thead>
                      <tr className="text-muted-foreground border-b">
                        ...
                        {hasCapital && (
                          <th className="text-right font-medium py-1.5 px-2">资金面分</th>
                        )}
                        {hasSector && (
                          <th className="text-right font-medium py-1.5 px-2">赛道分</th>
                        )}
                        {hasRank && (
                          <th className="text-right font-medium py-1.5 px-2">同类排名</th>
                        )}
